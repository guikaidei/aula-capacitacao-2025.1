...
connect(db="app_reservas",
        host=f"mongodb+srv://{os.getenv('MONGO_USER')}:{os.getenv('MONGO_PWD')}@cluster0.3sv6j.mongodb.net/?retryWrites=true&w=majority&appName=AppReservas"
        )
